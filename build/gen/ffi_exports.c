...
void  mgos_liquidcrystal_i2c_autoscroll(void *);
void  mgos_liquidcrystal_i2c_backlight(void *);
void  mgos_liquidcrystal_i2c_blink(void *);
void  mgos_liquidcrystal_i2c_clear(void *);
void  mgos_liquidcrystal_i2c_close(void *);
void  mgos_liquidcrystal_i2c_command(void *, int);
void * mgos_liquidcrystal_i2c_create(int, int, int);
void  mgos_liquidcrystal_i2c_cursor(void *);
void  mgos_liquidcrystal_i2c_display(void *);
int  mgos_liquidcrystal_i2c_getAddr(void *);
void  mgos_liquidcrystal_i2c_home(void *);
void  mgos_liquidcrystal_i2c_init(void *);
void  mgos_liquidcrystal_i2c_leftToRight(void *);
void  mgos_liquidcrystal_i2c_noAutoscroll(void *);
void  mgos_liquidcrystal_i2c_noBacklight(void *);
void  mgos_liquidcrystal_i2c_noBlink(void *);
void  mgos_liquidcrystal_i2c_noCursor(void *);
void  mgos_liquidcrystal_i2c_noDisplay(void *);
int  mgos_liquidcrystal_i2c_print(void *, char *);
void  mgos_liquidcrystal_i2c_rightToLeft(void *);
void  mgos_liquidcrystal_i2c_scrollDisplayLeft(void *);
void  mgos_liquidcrystal_i2c_scrollDisplayRight(void *);
void  mgos_liquidcrystal_i2c_setCursor(void *, int, int);
...
const struct mgos_ffi_export ffi_exports[] = {
  ...
  {"mgos_liquidcrystal_i2c_autoscroll", mgos_liquidcrystal_i2c_autoscroll},
  {"mgos_liquidcrystal_i2c_backlight", mgos_liquidcrystal_i2c_backlight},
  {"mgos_liquidcrystal_i2c_blink", mgos_liquidcrystal_i2c_blink},
  {"mgos_liquidcrystal_i2c_clear", mgos_liquidcrystal_i2c_clear},
  {"mgos_liquidcrystal_i2c_close", mgos_liquidcrystal_i2c_close},
  {"mgos_liquidcrystal_i2c_command", mgos_liquidcrystal_i2c_command},
  {"mgos_liquidcrystal_i2c_create", mgos_liquidcrystal_i2c_create},
  {"mgos_liquidcrystal_i2c_cursor", mgos_liquidcrystal_i2c_cursor},
  {"mgos_liquidcrystal_i2c_display", mgos_liquidcrystal_i2c_display},
  {"mgos_liquidcrystal_i2c_getAddr", mgos_liquidcrystal_i2c_getAddr},
  {"mgos_liquidcrystal_i2c_home", mgos_liquidcrystal_i2c_home},
  {"mgos_liquidcrystal_i2c_init", mgos_liquidcrystal_i2c_init},
  {"mgos_liquidcrystal_i2c_leftToRight", mgos_liquidcrystal_i2c_leftToRight},
  {"mgos_liquidcrystal_i2c_noAutoscroll", mgos_liquidcrystal_i2c_noAutoscroll},
  {"mgos_liquidcrystal_i2c_noBacklight", mgos_liquidcrystal_i2c_noBacklight},
  {"mgos_liquidcrystal_i2c_noBlink", mgos_liquidcrystal_i2c_noBlink},
  {"mgos_liquidcrystal_i2c_noCursor", mgos_liquidcrystal_i2c_noCursor},
  {"mgos_liquidcrystal_i2c_noDisplay", mgos_liquidcrystal_i2c_noDisplay},
  {"mgos_liquidcrystal_i2c_print", mgos_liquidcrystal_i2c_print},
  {"mgos_liquidcrystal_i2c_rightToLeft", mgos_liquidcrystal_i2c_rightToLeft},
  {"mgos_liquidcrystal_i2c_scrollDisplayLeft", mgos_liquidcrystal_i2c_scrollDisplayLeft},
  {"mgos_liquidcrystal_i2c_scrollDisplayRight", mgos_liquidcrystal_i2c_scrollDisplayRight},
  {"mgos_liquidcrystal_i2c_setCursor", mgos_liquidcrystal_i2c_setCursor},
